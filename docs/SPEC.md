...
- Manual transcription pipeline: `recall transcribe latest` (default Apple SpeechAnalyzer on Apple Silicon macOS 26+; `--engine parakeet` and `--engine whisper` remain)
